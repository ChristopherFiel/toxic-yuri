init python:
    ...
    for file in renpy.list_files():
        ...
        if file.startswith('images/bg/'):
            if any(suffix in file for suffix in ["_day", "_dawn", "_dusk", "_night", "_moonlit", "_sepia", "_rain"]):
                continue
            ...
            if match:
                ...
                renpy.image(img_name + "_moonlit", im.MatrixColor(img_path, tint_moonlit))  # ← NEW
                ...
                renpy.image(img_name, ConditionSwitch(
                    ...
                    "time_of_day == 'MOONLIT'",  img_name + "_moonlit",  # ← NEW
